...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* FixedColumns: keep left-pinned cells from turning grey */
    .dtfc-fixed-left td  { background: inherit !important; }
    .dtfc-fixed-left th  { background: #2c3e50 !important; color: #fff !important; }
